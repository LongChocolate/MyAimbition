...
export const htmlCode = {
    ...
    <html lang="en">
        ...
        <style>
            ...
            body {
                background: linear-gradient(#09256f,${colors.darkGrey});
            ...
            .christmas:before, .letter:before {
                content: '';
                position: absolute;
                top: 0;
                left: 0;
                ...
                height: 100%;
                transform: rotate(-10deg);
                background-image: radial-gradient(circle at 20% 25%, #fff 1.5%, transparent 2.5%),
                    radial-gradient(circle at 90% 70%, #fff 1.5%, transparent 1%),
                    radial-gradient(circle at 20% 40%, #fff 0.5%, transparent 1.5%),
                    radial-gradient(circle at 50% 85%, #fff 1%, transparent 2%);
            ...
            .gifts .largegift {
                ...
                opacity:0.6;
                border: solid 1px #654023;
            }
            .gifts .largegift:after {
                content:" ";
                width:70px;
                height:27px;
            ...
            .gifts .largegift .decor .bowup2 {
                ...
                left:50px;
                bottom:20px;
                transform: skewX(-50deg) rotate(90deg);
                z-index:1;
            }

            .gifts .largegift .decor .bowfront {
            ...
            .gifts .largegift .decor .bowright {
                width:5px;
                height:43px;
                position:absolute;
                background:red;
        ...
        <body id="body" style="display: flex;height: 100vh">.
            <div id="btn"  class="letter" >
                <svg
                    ...
                    enable-background="new 0 0 100 88.4"
                    xml:space="preserve"
                    ...
                    <g id="__id2_s23t51u2c">
                        <path
                            ...
                            style="fill: ${colors.lightGreen}"></path>
                    </g>
                    <g id="__id3_s23t51u2c"
                    style="fill: ${colors.error};  opacity:0.75">
                        <path
                            ...
                            style="fill: ${colors.error}"></path>
                    </g>
                </svg>
                <h1 style="text-align: center; color: ${colors.white}">Nhấn vào thư em nhé !!!</h1>
                
                <div class="gifts">
                    <div class="largegift">
                        <div class="decor">
                            <div class="bowup1"></div>
                            <div class="bowup2"></div>
                            <div class="bowfront"></div>
                            <div class="bowright"></div>
                        </div>
                    </div>
                    <div class="smallgift"></div>
                </div>
            </div>
            ...
            <div class="christmas">
                <div class="message">
                    ...
                    <h2>Chúc em coá giáng sinh vui vẻ♥</h2>
                </div>
                <div class="window">
                    <div class="santa">
                        <div class="head">
